    ...
    <div class="row justify-content-center">
      <div class="col-md-10 mb-5 text-center">
        <ul class="product-category">
          ...
          <li><a href="relatorios_adm.php" class="active">Relatórios</a></li>
        ...
        <div class="col-md-12 ftco-animate">
          <div class="row">
            <div class="col-md-12 align-items-center text-center"> 
              <h4 class="pb-4">Relatórios</h4>   

              <div class="form-group text-center pt-4">

                <a href="relatorio_cliente.php" class="btn btn-primary">Relatório de Clientes</a> 
              </div>
              <div class="form-group text-center pt-4">
                <a href="relatorio_funcionario.php" class="btn btn-primary">Relatório de Funcionários</a> 
              </div>
              <div class="form-group text-center pt-4">
                <a href="relatorio_de_trocas.php" class="btn btn-primary">Relatório de Trocas</a>
              </div>
            </div>
          </div>
