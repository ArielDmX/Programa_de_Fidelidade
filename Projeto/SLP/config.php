    ...
    <div class="row justify-content-center">
      <div class="col-md-10 mb-5 text-center">
        <ul class="product-category">
          <li><a href="settings.php">Visão geral</a></li>
        ...
        <div class="col-md-12 ftco-animate">
          <div class="row">
            <div class="col-md-6 align-items-center text-center"> 
              <h4 class="pb-4">Atualizar Configurações</h4>   
              <form class="signup-form" method="POST" action="action_config.php?acao=inserir">

                <div class="form-group">

                  <input type="number" class="form-control" placeholder="Multiplicador" id="multiplicador" min="1" name="multiplicador" required="required">
                  <p>A cada R$1 na compra o cliente ganha X pontos</p>

                </div>

                <div class="form-group text-center pt-4">

                  <input type="submit" class="btn btn-primary" value="Atualizar"></p>
            ...
            <div class="col-md-6 align-items-center text-center"> 
              <h4 class="pb-4">Configurações atuais</h4>   
              

                <div class="form-group">

                  <input type="text" class="form-control" disabled placeholder="Niveis: <?=$configuracao[0]->qtde_niveis?>" id="cod" name="cod" required="required">
                  <input type="text" class="form-control" disabled placeholder="multiplicador: <?=$configuracao[0]->multiplicador?>" id="cod" name="cod" required="required">
                  <input type="text" class="form-control" disabled placeholder="Ultima alteração: <?=$configuracao[0]->dthr_alteracao?>" id="cod" name="cod" required="required">
