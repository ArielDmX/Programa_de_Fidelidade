...
<?php if (isset($_GET['msg']) && $_GET['msg'] == 2){?>
  <div class="bg-danger pt-2 d-flex justify-content-center">
    <h5 class="color-msg">Código já inserido</h5>
  </div>
<?php } ?>
  ...
  <div class="row justify-content-center">
    <div class="col-md-10 mb-5 text-center">
      <ul class="product-category">
        <li><a href="visao_geral.php" class="active">Visão geral</a></li>
        <li><a href="historico_pontos.php">Histórico de pontos</a></li>
        <li><a href="historico_trocas.php">Histórico de trocas</a></li>
        <!--<li><a href="#"></a></li>
      ...
      <div class="col-md-12 ftco-animate">
        <div class="row">
          <div class="col-md-6 align-items-center text-center"> 
            <h4 class="pb-4">Cadastre seus pontos</h4>   
            <form class="signup-form" method="POST" action="action_ponto.php?acao=inserir">

              <div class="form-group">

                <input type="text" class="form-control" placeholder="Cód. de compras" id="cod" name="cod" required="required">

                <input type="hidden" name="c_ou_d" value="c">

              </div>

              <div class="form-group text-center pt-4">

                <input type="submit" class="btn btn-primary" value="Cadastrar"></p>
          ...
          <div class="col-md-5">    
            <h4 class="text-center" style="margin-bottom: 40px;">Nível <?= $i ?></h4>
...
<section class="ftco-section ftco-cart pt-0">
  <div class="container">
    <div class="row">
      <div class="col-md-12 ftco-animate">
        <div class="cart-list">
          <h3 class="pb-5 d-flex justify-content-center">Histórico de pontos</h3>   
          <table class="table">
