   ...
   <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ftco-category">
     ...
     <div class="d-flex justify-content-center pt-4 pb-2">
      <span class="icon-mail_outline visual"></span>
    </div>
    <div class="modal-body category-wrap-2 d-flex justify-content-center">
      <div class="d-flex justify-content-center text pb-4 ">
        <span class="color-modal"><h2 class="">Quase lá!<h2></span>
          <p class="small">Acesse seu e-mail e finalize o cadastro.</p>
        </div>
...
<div class="modal fade" id="modal-mensagem-3">
 <div class="modal-dialog modal-dialog-centered">
  ...
  <div class="modal-body category-wrap-2 d-flex justify-content-center">
    <div class="d-flex justify-content-center text pb-4 ">
      <span class="color-modal"><h2 class="">OOPS!!!<h2></span>
        <p class="small">Este CPF já está cadastrado.</p>
      </div>
  ...
  <div class="row justify-content-center">
    <div class="col-md-10 mb-5 text-center">
      <ul class="product-category">
        ...
        <li><a href="cadastro_adm.php" class="active">Cadastrar ADM</a></li>
        <!--<li><a href="#"></a></li>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-6 ">
          ...
          <form class="signup-form" method="post" action="action_adm.php?acao=inserir">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control .cpf" placeholder="Senha" id="senha" name="senha" onblur="TestaCPF(this.value);" required="required">
            ...
            <input type="hidden" id="empresa_cnpj" name="empresa_cnpj" required="required" value="64468886000186">
           ...
           <div class="form-group text-center pt-4">
            ...
            <input type="submit" class="btn btn-primary px-4 py-3" value="Cadastrar"></p>
